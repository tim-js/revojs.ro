    ...
    <Layout>
      <Header className="cfp-header">
        ...
        <Content>
          ...
          <br />
          <strong className="cfp-highlight">Type fast, the Call for Speakers closes on ???</strong>
          <br />
          <br />
          <br />
          <Button href="#">
      ...
      <Section light content className="cfp-content">
        ...
        <section>
          ...
          <h3>Language:</h3>
          <p>
            English. Inglese. Engelsk. Angleško. Angolul. (but we’d love for you
            to teach us some words in your language too)
          </p>
